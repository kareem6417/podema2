  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <h1 class="card-title fw-semibold mb-4">Device Inspection (CCTV)</h1>
          <form id="assessmentForm" method="post" action="submit_ins.php" class="content" enctype="multipart/form-data">
          <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                  ...
                  <div class="form-group">
                      ...
                      <input type="jenis" id="jenis" name="jenis" class="form-control" value="CCTV" readonly>
                  </div>
              </div>
              <div class="form-group">

    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          ...
          <form id="assessmentForm" method="post" action="submit_monitor.php" class="content" enctype="multipart/form-data">
          <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                  ...
                  <div class="form-group">
                      ...
                      <input type="jenis" id="jenis" name="jenis" class="form-control" value="Monitor" readonly>
                  </div>
              </div>
              <div class="form-group">

  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <h1 class="card-title fw-semibold mb-4">Device Inspection (Printer)</h1>
          <form id="assessmentForm" method="post" action="submit_printer.php" class="content" enctype="multipart/form-data">
          <div class="row">
            <div class="col-md-6">
            ...
            <script>
              ...
              <div class="col-md-6">
                  ...
                  <div class="form-group">
                      ...
                      <input type="jenis" id="jenis" name="jenis" class="form-control" value="Printer" readonly>
                  </div>
              </div>
              <div class="form-group">
              ...
              <br>
                ...
                <select id="ink_pad" name="ink_pad" style="height: 50px;">
                    <option value="">--- Pilih ---</option>
                    <?php

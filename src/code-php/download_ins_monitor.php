...
$query = $conn->prepare("SELECT fi.*, s.screenshot_name, cl.casing_lap_name, cl.casing_lap_score, ip.layar_lap_name, ip.layar_lap_score 
...
// Isi Tabel untuk Layar
$pdf->Cell(40, 20, 'Layar', 1, 0, 'C', true);
$pdf->MultiCell(110, 10, $row['layar_lap_name'], 1, 'C', false, 1, '', '', true, 0, false, true, 10, 'T');

// Mengatur posisi X dan Y untuk skor
$pdf->SetXY(160, $pdf->GetY() - 20);
$pdf->Cell(30, 20, $row['layar_lap_score'], 1, 1, 'C', true);

// Total Skor
$totalScore = $row['casing_lap_score'] + $row['layar_lap_score'];
$pdf->SetFont('helvetica', 'B', 11);

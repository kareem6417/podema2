              ...
              <div class="card-body">
                  ...
                  ?>
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-6">
                              <div class="form-group">
                                  ...
                                  <br>
                                  <label for="typepc"><strong>Type PC</strong></label>
                                  <p id="typepc" name="typepc" class="form-control" ><?= isset($query['typepc']) ? $query['typepc'] : '' ?></p>
                                  <br>
                      ...
                      <div class="button-container">
                          <input type="button" class="btn btn-secondary" value="Back" onclick="window.location.href='assess_pc.php';">
                          <a href="downloadpc.php" download class="btn btn-primary">Download</a>
                      </div>
                  </form>
              </div>
          </div>

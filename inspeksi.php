...
<body>
    <div class="container">
        ...
        <form id="assessmentForm" method="post" action="submit_inspeksi.php" class="content" enctype="multipart/form-data">
            ...
            <input type="file" id="upload_file" name="upload_file" style="background-color: #4CAF50; color: white; padding: 10px 20px; border-radius: 5px; font-size: 14px; margin-bottom: 10px; width: 13%; display: inline-bloack;" accept=".zip, .rar" required class="device-select">
